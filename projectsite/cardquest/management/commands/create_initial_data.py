...
class Command(BaseCommand):
    ...
    def create_trainers(self):
        ...
        trainer9 = Trainer(name="John",birthdate= "2002-08-24",location= "Palawan",email= "john@pokemon.com")
        trainer10 = Trainer(name="Rafael" ,birthdate= "2002-08-24" ,location= "Laguna" ,email= "rafael@pokemon.com")
